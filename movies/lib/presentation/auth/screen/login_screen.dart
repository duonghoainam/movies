                ...
                child: Container(
                  ...
                  child: SingleChildScrollView(
                    child: Column(
                      ...
                      crossAxisAlignment: CrossAxisAlignment.stretch,
                      children: [
                        Image.asset(AppString.assetUrlLogo, width: 80, height: 80,),
                        ...
                        ReactiveTextField<String>(
                          ...
                          decoration: const InputDecoration(hintText: 'Email', hintStyle: TextStyle(color: AppColors.white)),
                        ),
                        ...
                        ValueListenableBuilder(
                          ...
                          builder: (context, value, child) => ReactiveTextField<String>(
                            ...
                            decoration: InputDecoration(hintText: 'Password', hintStyle: TextStyle(color: AppColors.white),
                                suffixIcon: IconButton(
                                  icon: Icon(isObscure.value? Icons.visibility_off : Icons.visibility, color: AppColors.white),
